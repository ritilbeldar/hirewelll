          ...
          (r = function (t) {
            return (function (t, e, n, a) {
              ...
              return (
                ...
                (r.ext.renderer.pageButton.bootstrap = function (
                  e,
                  o,
                  i,
                  l,
                        ...
                        if (((d = a[r]), t.isArray(d))) m(n, d);
                          ...
                          c &&
                            ((l = t("<li>", {
                              ...
                              .appendTo(n)),
                            e.oApi._fnBindAction(l, { action: d }, S),
                            v++);
                        }
                    };
                  try {
              ...
              return (function (t, e, n, a) {
                      ...
                      this.each(function () {
                        ...
                        if ("table" == this.nodeName.toLowerCase()) {
                          L(d),
                            ...
                            I(d, t.extend(o, h.data()));
                          var p = s.settings;
                          for (u = 0, r = p.length; u < r; u++) {
                            var g = p[u];
                            if (
                              g.nTable == this ||
                              g.nTHead.parentNode == this ||
                          ...
                          if (
                            (0 !== x.length &&
                              (ct(m.aoHeader, x[0]), (C = ft(m))),
                            null === o.aoColumns)
                          )
                            for (T = [], u = 0, r = C.length; u < r; u++)
                              T.push(null);
                          else T = o.aoColumns;
                          ...
                          var j = m.oFeatures,
                            O = function () {
                              ...
                              0 === l.length && (l = t("<tbody/>").appendTo(h)),
                                (m.nTBody = l[0]);
                              ...
                              if (
                                ...
                                0 === s.length || 0 === s.children().length
                                  ...
                                  : s.length > 0 &&
                                    ((m.nTFoot = s[0]),
                                    ct(m.aoFooter, m.nTFoot)),
                                o.aaData)
                              )
                                for (u = 0; u < o.aaData.length; u++)
                                  V(m, o.aaData[u]);
                              else
                                (m.bDeferLoading || "dom" == pe(m)) &&
                                  X(m, t(m.nTBody).children("tr"));
                          ...
                          o.bStateSave
                            ? ((j.bStateSave = !0),
                              ce(m, "aoDrawCallback", ae, "state_save"),
                              re(m, o, O))
                            : O();
                ...
                function E(t) {
                  ...
                  for (e = 0, n = d.length; e < n; e++)
                    if (((u = d[e]), (f = []), !u.sType && u._sManualType))
                ...
                function U(e, n, r, o) {
                  ...
                  if (n)
                    for (i = n.length - 1; i >= 0; i--) {
                      ...
                      for (
                        t.isArray(p) || (p = [p]), s = 0, u = p.length;
                        s < u;
                        s++
                      )
                ...
                function Z(e) {
                  ...
                  var n = function (e, r, o) {
                    for (
                      ...
                      s && ((f[h] = f[h].replace($, "")), (e = e[f[h]](r))),
                        (null !== e[f[h]] && e[f[h]] !== a) || (e[f[h]] = {}),
                        (e = e[f[h]]);
                    }
                    d.match($)
                      ? (e = e[d.replace($, "")](r))
                ...
                function nt(e, n, r, o) {
                  ...
                  if (c)
                    ...
                    for (var b = 0, v = (u = n.anCells).length; b < v; b++)
                      g(u[b]);
                ...
                function lt(e) {
                  ...
                  if (-1 === t.inArray(!1, n)) {
                    ...
                    var d = e._iDisplayStart,
                      h = e.fnDisplayEnd();
                    if (e.bDeferLoading)
                      (e.bDeferLoading = !1), e.iDraw++, Wt(e, !1);
                    else if (c) {
                      if (!e.bDestroying && !ht(e)) return;
                    } else e.iDraw++;
                    if (0 !== f.length)
                      for (
                        var p = c ? 0 : d, g = c ? e.aoData.length : h, b = p;
                        b < g;
                        b++
                      ) {
                        var v = f[b],
                        ...
                        if (0 !== l) {
                          var D = i[o % l];
                          m._sRowStripe != D &&
                            (t(S).removeClass(m._sRowStripe).addClass(D),
                            (m._sRowStripe = D));
                        }
                        fe(e, "aoRowCallback", null, [S, m._aData, o, b]),
                          r.push(S),
                          o++;
                      }
                    else {
                  ...
                  for (o = 0, s = p.length; o < s; o++)
                    for (a = p[o], c = 0, r = a.firstChild; r; ) {
                      if (
                        ...
                        for (
                          f = 1 * r.getAttribute("colspan"),
                            d = 1 * r.getAttribute("rowspan"),
                            f = f && 0 !== f && 1 !== f ? f : 1,
                            d = d && 0 !== d && 1 !== d ? d : 1,
                            u = g(e, o, c),
                            h = 1 === f,
                    ...
                    error: function (n, a, r) {
                      ...
                      -1 === t.inArray(!0, o) &&
                        ("parsererror" == a
                          ...
                          : 4 === n.readyState && ie(e, 0, "Ajax error", 7)),
                        Wt(e, !1);
                    },
                  };
                  (e.oAjaxData = n),
                ...
                function mt(t, e, n) {
                  ...
                  if ((E(t), "ssp" != pe(t))) {
                    yt(t, e.sSearch, n, l(e), e.bSmart, e.bCaseInsensitive),
                      i(e);
                ...
                function Bt(e) {
                  ...
                  return (
                    ...
                    (e.nScrollBody = v),
                    (e.nScrollFoot = m),
                    e.aoDrawCallback.push({ fn: Et, sName: "scrolling" }),
                    p[0]
                  );
                }
                function Et(e) {
                  ...
                  if (e.scrollBarVis !== X && e.scrollBarVis !== a)
                    return (e.scrollBarVis = X), void O(e);
                  (e.scrollBarVis = X),
                    L.children("thead, tfoot").remove(),
                    j &&
                      ((s = j.clone().prependTo(L)),
                      (r = j.find("tr")),
                      (i = s.find("tr"))),
                    (l = F.clone().prependTo(L)),
                    (n = F.find("tr")),
                    (o = l.find("tr")),
                    ...
                    "" === h
                      ? ((R.width = "100%"),
                        N &&
                          ...
                          (R.width = zt(L.outerWidth() - b)),
                        (f = L.outerWidth()))
                      : "" !== p && ((R.width = zt(p)), (f = L.outerWidth())),
                    Ut(V, o),
                    Ut(function (e) {
                    ...
                    L.outerWidth() < f
                      ? ((c =
                        ...
                        N &&
                          ...
                          (R.width = zt(c - b)),
                        ("" !== h && "" === p) ||
                          ie(e, 1, "Possible column misalignment", 6))
                      : (c = "100%"),
                    (C.width = zt(c)),
                    (m.width = zt(c)),
                    j && (e.nScrollFoot.style.width = zt(c)),
                    g || (N && (C.height = zt(P.offsetHeight + b)));
                  var J = L.outerWidth();
                  ...
                  (y[G] = q ? b + "px" : "0px"),
                    j &&
                      ((A[0].style.width = zt(J)),
                      (I[0].style.width = zt(J)),
                      (I[0].style[G] = q ? b + "px" : "0px")),
                ...
                function Xt(n) {
                  var a,
                    ...
                    D = i.style.width;
                  for (
                    D && -1 !== D.indexOf("%") && (g = D), a = 0;
                    a < h.length;
                    a++
                  )
                    null !== (r = l[h[a]]).sWidth &&
                      ((r.sWidth = qt(r.sWidthOrig, b)), (v = !0));
                ...
                function Yt(e) {
                  ...
                  for (
                    ...
                    for (
                      c = g[n][0], i = d[c].aDataSort, r = 0, o = i.length;
                      r < o;
                      r++
                    )
                      (l = i[r]),
                ...
                function Zt(t) {
                  var e,
                    ...
                    c = (t.aoColumns, 0),
                    f = t.aiDisplayMaster;
                  for (E(t), o = Yt(t), e = 0, n = o.length; e < n; e++)
                ...
                function ee(e) {
                  ...
                  if (s.bSort && s.bSortClasses) {
                    for (n = 0, a = o.length; n < a; n++)
                      (r = o[n].src),
                        t(D(e.aoData, "anCells", r)).removeClass(
                          i + (n < 2 ? n + 1 : 3)
                        );
                    for (n = 0, a = l.length; n < a; n++)
                      (r = l[n].src),
                        t(D(e.aoData, "anCells", r)).addClass(
                          i + (n < 2 ? n + 1 : 3)
                        );
                  }
                  e.aLastSort = l;
                ...
                function re(e, n, r) {
                  var o,
                    ...
                    s = function (n) {
                      if (n && n.time) {
                        var s = fe(e, "aoStateLoadParams", "stateLoadParams", [
                          e,
                          n,
                        ]);
                        if (-1 === t.inArray(!1, s)) {
                          ...
                          if (u > 0 && n.time < +new Date() - 1e3 * u) r();
                            ...
                            if (
                              ...
                              n.search !== a &&
                                t.extend(e.oPreviousSearch, At(n.search)),
                              n.columns)
                            )
                ...
                function ie(t, n, a, r) {
                  if (
                    ...
                    if ((t && fe(t, null, "error", [t, r, a]), "alert" == i))
                      alert(a);
                    else {
                  ...
                  (o.extend = function (e, n, a) {
                    if (a.length && n && (n instanceof o || n.__dt_wrapper)) {
                      ...
                      for (r = 0, i = a.length; r < i; r++)
                        (l = a[r]),
                          (n[l.name] =
                            "function" == typeof l.val
                              ? s(e, l.val, l)
                              : t.isPlainObject(l.val)
                              ? {}
                              : l.val),
                          (n[l.name].__dt_wrapper = !0),
                          o.extend(e, n[l.name], l.propExt);
                    }
                  }),
                  (o.register = i =
                    function (e, n) {
                ...
                var ve = function (t, e, n) {
                  ...
                  if ("ssp" == pe(t)) st(t, e);
                    ...
                    r && 4 !== r.readyState && r.abort(),
                      dt(t, [], function (n) {
                        Q(t);
                        for (var a = bt(t, n), r = 0, o = a.length; r < o; r++)
                          V(t, a[r]);
                        st(t, e), Wt(t, !1);
                      });
                  }
                ...
                var me = function (e, n, o, i, l) {
                    ...
                    for (
                      ...
                      for (
                        ...
                        (s = o(
                          "string" == typeof u[d] ? t.trim(u[d]) : u[d]
                        )) &&
                          s.length &&
                          (p = p.concat(s));
                    var b = r.selector[e];
                  ...
                  ye = function (e, n) {
                    var a,
                      ...
                      f = n.page;
                    if ("ssp" == pe(e))
                      return "removed" === u ? [] : _(0, s.length);
                    if ("current" == f)
                      for (
                        a = e._iDisplayStart, r = e.fnDisplayEnd();
                        a < r;
                        a++
                      )
                        i.push(l[a]);
                ...
                function Re(t) {
                  return function () {
                    var e = [oe(this[s.ext.iApiIndex])].concat(
